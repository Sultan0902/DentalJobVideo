package com.vishant.DentalJobVideo.adapter.QB.calling;
    ...
    public View getView(final int position, View convertView, final ViewGroup parent) {
        ...
        if (user != null) {
            ...
            if (selectedItems.contains(user)){
                ...
                holder.opponentIcon.setImageResource(R.mipmap.ic_checkmark);
            } else {
                ...
                holder.opponentIcon.setImageResource(R.mipmap.ic_person);
            }
        }
