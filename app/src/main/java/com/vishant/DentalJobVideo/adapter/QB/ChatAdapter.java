package com.vishant.DentalJobVideo.adapter.QB;
...
import com.vishant.DentalJobVideo.activity.QB.AttachmentImageActivity;
import com.vishant.DentalJobVideo.ui.qb.MaskedImageView;
import com.vishant.DentalJobVideo.utils.QB.Consts;
import com.vishant.DentalJobVideo.utils.QB.TimeUtils;
...
import com.vishant.DentalJobVideo.utils.QB.qb.QbUsersHolder;
...
public class ChatAdapter extends BaseListAdapter<QBChatMessage> implements StickyListHeadersAdapter {
    ...
    private void setIncomingOrOutgoingMessageAttributes(ViewHolder holder, QBChatMessage chatMessage) {
        ...
        int messageBodyContainerBgResource = isIncoming
                ? R.mipmap.incoming_message_bg
                : R.mipmap.outgoing_message_bg;
        if (hasAttachments(chatMessage)) {
