...
public class VerboseQbChatConnectionListener implements ConnectionListener {
    ...
    public void connectionClosedOnError(final Exception e) {
        ...
        snackbar = Snackbar.make(rootView, DentalJobVideoApplication.getInstance().getString(R.string.connection_error), Snackbar.LENGTH_INDEFINITE);
        snackbar.show();
    }
    ...
    public void reconnectingIn(final int seconds) {
        if (seconds % 5 == 0 && seconds != 0) {
            ...
            snackbar = Snackbar.make(rootView, DentalJobVideoApplication.getInstance().getString(R.string.reconnect_alert, seconds+""), Snackbar.LENGTH_INDEFINITE);
            snackbar.show();
        }
    }
