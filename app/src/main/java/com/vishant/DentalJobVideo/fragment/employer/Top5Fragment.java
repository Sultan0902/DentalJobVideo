...
import static com.vishant.DentalJobVideo.activity.employeer.NavigationDrawerEmployerActivity.TOP5_CANDIDATE_TYPE;
 ...
 * Use the {@link Top5Fragment#newInstance} factory method to
...
public class Top5Fragment extends Fragment {
    ...
    public final static String TOP5_FRAGMENT = "Top5Fragment";
    ...
    public static Top5Fragment newInstance(String param1, String param2) {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_employer_top5, container, false);
    ...
    private void initializeHeader(View view){
        ...
        tvHeaderTitle.setText(getResources().getString(R.string.top5_fragment));
    }
    ...
    private void initUIDependencies(View view){
        ...
        tvJobRecyclerView = (RecyclerView) view.findViewById(R.id.top5_employeer_recyclerview);
        swipeRefreshLayout = (SwipeRefreshLayout) view.findViewById(R.id.top5_recyclerview_swipeRefresh);
    }

    private void initData(){
        top5List = new ArrayList<JobInfoModel>();
    ...
    private void initializeRecyclerView(){
        ...
        adapter = new EmployerJobRVAdapter(top5List, getContext());
    ...
    public void onJobItemClicked(JobInfoModel item, boolean video) {
        if (mListener != null) {
            if (video) {
                mListener.onJobVideoItemClicked(item, TOP5_CANDIDATE_TYPE);
            }
            else {
                mListener.onJobTextItemClicked(item, TOP5_CANDIDATE_TYPE);
            }
        }
    }
    ...
    public void loadJobsFromServer(final boolean refresh){
        ...
        if(employerData != null){
            progressDialog.show();
            Call<JobInfoResponse> call = jobEmployeer.getEmployerTop5Resume(employerData.getKey(), employerData.getId()+"", page + "");
                ...
                public void onResponse(Call<JobInfoResponse> call, Response<JobInfoResponse> response) {
                    ...
                    if(jobInfoResponse.getStatus().equals("SUCCESS")){
                        ...
                        if(jobInfoResponse.getData().size() > 0) {
                            ...
                            showToast(tvJobRecyclerView, "No Top 5 Resume Found");
                        }
